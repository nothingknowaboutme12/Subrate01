...
class LessonTaskCompletedScreen extends StatefulWidget {
  ...
  @override
  State<LessonTaskCompletedScreen> createState() =>
      _LessonTaskCompletedScreenState();
}

class _LessonTaskCompletedScreenState extends State<LessonTaskCompletedScreen> {
  late double width;
  late double height;
